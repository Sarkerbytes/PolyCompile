#ifndef PARSER_CPP_HPP
#define PARSER_CPP_HPP
...
private:
    ...
    ASTNodePtr parseCoutStatement();
    ASTNodePtr parseCinStatement();
...
public:
    Parser_CPP(const std::vector<Token>& tks, const std::string& fname = "source.cpp");
    ASTNodePtr parse();
};

#endif // PARSER_CPP_HPP
